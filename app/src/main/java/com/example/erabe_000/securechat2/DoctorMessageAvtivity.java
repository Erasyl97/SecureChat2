...
public class DoctorMessageAvtivity extends AppCompatActivity {
    ...
    private DatabaseReference dbr3 = FirebaseDatabase.getInstance().getReference("doctors");
    Doctor doctor1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_message_avtivity);
        ...
        dbr3.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    ...
                    {
                        talkingUserID = doctor1.getUserid();
                        setTitle(doctor1.getUserFullname());
                        UserName = doctor1.getUsername();
                        UserFullName = doctor1.getUserFullname();
                        publicRsaKey = doctor1.getPublicRSAKey();
                        break;
                    }
                }
        ...
        btnSendMsg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference dbr3 = dbr.child(user_msg_key);
